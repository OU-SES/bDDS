...
*
*/
void SBDP_THREAD::task_lock_init() {
...
*
*/
void SBDP_THREAD::task_mutex_wlock(task_lock_t* lock) {
...
*
*/
void SBDP_THREAD::task_mutex_rlock(task_lock_t* lock) {
	boost::mutex::scoped_lock(lock->lock_mutex);
...
*
*/
void SBDP_THREAD::task_mutex_unlock(task_lock_t* lock) {
	boost::mutex::scoped_lock(lock->lock_mutex);
